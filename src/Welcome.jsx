...
function Welcome() {
  ...
  return (
    <div className="bg-gradient-to-r from-yellow-400 to-yellow-100 mx-10 content-center grid place-items-center">
      <h2 className="inline-block align-top motion-safe:animate-bounce text-center mb-4 text-9xl font-extrabold leading-none tracking-tight text-gray-900 md:text-5xl lg:text-6xl dark:text-white pt-10">
        Welcome
      </h2>
